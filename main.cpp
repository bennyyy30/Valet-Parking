...
void passage_1() {
  ...
  if (assertEquals("test " + std::to_string(assertEquals.tests), 1U, myvalet.totalStallSpaces()) and
...
void passage_2() {
  ...
  ValetParking myvalet;
  double totaltest = 12.0;
  if (assertEquals("test " + std::to_string(assertEquals.tests), 1U, myvalet.checkIn()) and
...
void passage_5() {
  ...
  if (assertEquals("test " + std::to_string(assertEquals.tests), 6U, myvalet.totalStallSpaces()) and
...
void passage_8() {
  ...
  double totaltest = 45.0;
  if (assertEquals("test " + std::to_string(assertEquals.tests), 600U, myvalet.totalStallSpaces()) and
      assertEquals("test " + std::to_string(assertEquals.tests), 1U, myvalet.checkIn()) and
      assertEquals("test " + std::to_string(assertEquals.tests), 1U, myvalet.checkIn()) and
      assertEquals("test " + std::to_string(assertEquals.tests), 1U, myvalet.checkIn()) and
      assertEquals("test " + std::to_string(assertEquals.tests), 1U, myvalet.checkIn()) and
